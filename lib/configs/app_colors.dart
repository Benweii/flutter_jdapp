...
class AppColors {
  ...
  static const Color silvery = Color(0xfff3f2f8);

  static const Color lightWhite = Color(0xfffefefe);
  static const Color lightRed = Color(0xffe93b3d);
  static const Color deepRed = Color(0xffe4393c);
  static const Color lightGray = Color(0xffe8e8ed);
